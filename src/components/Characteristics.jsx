  ...
  const characteristics = [
    {
      ...
      btn1: '/img/icons/btn/1-rapidez.png',
      btn2: '/img/icons/btn/1-rapidez-select.png',
      icon2: '/img/icons/characteristics/1-rapidez-azul.png',
      color: 'white',
      background: '#172A49',
      id: 1,
    },
    {
      ...
      btn1: '/img/icons/btn/2-aislamiento.png',
      btn2: '/img/icons/btn/2-aislamiento-select.png',
      icon2: '/img/icons/characteristics/2-aislamiento-azul.png',
      color: '#172A49',
      background: '#F2CA99',
      id: 2,
    },
    {
      ...
      btn1: '/img/icons/btn/3-impermeabilidad.png',
      btn2: '/img/icons/btn/3-impermeabilidad-select.png',
      icon2: '/img/icons/characteristics/3-impermeabilidad-azul.png',
      color: '#172A49',
      background: '#94B8C4',
      id: 3,
    },
    {
      ...
      btn1: '/img/icons/btn/4-fuego.png',
      btn2: '/img/icons/btn/4-fuego-select.png',
      icon2: '/img/icons/characteristics/4-fuego-azul.png',
      color: 'white',
      background: '#172A49',
      id: 4,
    },
    {
      ...
      btn1: '/img/icons/btn/5-plagas.png',
      btn2: '/img/icons/btn/5-plagas-select.png',
      icon2: '/img/icons/characteristics/5-plagas-azul.png',
      color: '#172A49',
      background: '#F2CA99',
      id: 5,
    },
    {
      ...
      btn1: '/img/icons/btn/6-desperdicios.png',
      btn2: '/img/icons/btn/6-desperdicios-select.png',
      icon2: '/img/icons/characteristics/6-desperdicios-azul.png',
      color: '#172A49',
      background: '#94B8C4',
      id: 6,
    },
    {
      ...
      btn1: '/img/icons/btn/7-resistente.png',
      btn2: '/img/icons/btn/7-resistente-select.png',
      icon2: '/img/icons/characteristics/7-resistente-azul.png',
      color: 'white',
      background: '#172A49',
      id: 7,
    },
    {
      ...
      btn1: '/img/icons/btn/8-versatilidad.png',
      btn2: '/img/icons/btn/8-versatilidad-select.png',
      icon2: '/img/icons/characteristics/8-versatilidad-azul.png',
      color: '#172A49',
      background: '#F2CA99',
      id: 8,
    },
    {
      ...
      btn1: '/img/icons/btn/9-proceso-sostenible.png',
      btn2: '/img/icons/btn/9-proceso-sostenible-select.png',
      icon2: '/img/icons/characteristics/9-proceso-sostenible-azul.png',
      color: '#172A49',
      background: '#94B8C4',
      id: 9,
    },
    {
      ...
      btn1: '/img/icons/btn/10-revoques.png',
      btn2: '/img/icons/btn/10-revoques-select.png',
      icon2: '/img/icons/characteristics/10-revoques-azul.png',
      color: 'white',
      background: '#172A49',
      id: 10,
    },
    {
      ...
      btn1: '/img/icons/btn/11-reduccion.png',
      btn2: '/img/icons/btn/11-reduccion-select.png',
      icon2: '/img/icons/characteristics/11-reduccion-azul.png',
      color: '#172A49',
      background: '#F2CA99',
      id: 11,
    },
    {
      ...
      btn1: '/img/icons/btn/12-instalaciones.png',
      btn2: '/img/icons/btn/12-instalaciones-select.png',
      icon2: '/img/icons/characteristics/12-instalaciones-azul.png',
      color: '#172A49',
      background: '#94B8C4',
      id: 12,
    },
    {
      ...
      btn1: '/img/icons/btn/13-solucion-integral.png',
      btn2: '/img/icons/btn/13-solucion-integral-select.png',
      icon2: '/img/icons/characteristics/13-solucion-integral-azul.png',
      color: 'white',
      background: '#172A49',
      id: 13,
    },
    {
      ...
      btn1: '/img/icons/btn/14-sin-costos.png',
      btn2: '/img/icons/btn/14-sin-costos-select.png',
      icon2: '/img/icons/characteristics/14-sin-costos-azul.png',
      color: '#172A49',
      background: '#F2CA99',
      id: 14,
    },
